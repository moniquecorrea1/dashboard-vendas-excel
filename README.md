...
Os dados utilizados estão na aba Bases e incluem informações de plano, tipo de assinatura, renovação automática, valor total e produtos adicionais (EA Play e Minecraft Season Pass).
